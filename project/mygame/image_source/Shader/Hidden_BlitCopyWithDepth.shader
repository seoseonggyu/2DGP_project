...
void main()
{
    ...
    u_xlat10_0 = texture(_DepthTex, vs_TEXCOORD0.xy);
...
; Schema: 0
                                             ...
                                             %1 = OpExtInstImport "GLSL.std.450" 
                                                    OpMemoryModel Logical GLSL450 
                                                    OpEntryPoint Fragment %4 "main" %17 %32 %44 
...
UniformConstant read_only Texture2DSampled* %34 = OpVariable UniformConstant 
                                ...
                                Output f32* %44 = OpVariable Output 
                                        void %4 = OpFunction None %3 
                                             %5 = OpLabel 
                 ...
                 read_only Texture2DSampled %35 = OpLoad %34 
                                      ...
                                      f32_4 %37 = OpImageSampleImplicitLod %35 %36 
                                        f32 %40 = OpCompositeExtract %37 0 
                               Private f32* %42 = OpAccessChain %20 %39 
                                                    OpStore %42 %40 
                               Private f32* %45 = OpAccessChain %20 %39 
                                        f32 %46 = OpLoad %45 
                                                    OpStore %44 %46 
                                                    OpReturn
                                                    OpFunctionEnd
