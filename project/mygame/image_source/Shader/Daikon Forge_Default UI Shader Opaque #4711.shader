...
//
///////////////////////////////////////////
Shader "Daikon Forge/Default UI Shader Opaque" {
Properties {
_MainTex ("Base (RGB), Alpha (A)", 2D) = "white" { }
_UVRescale ("UVRescale", Vector) = (0,0,0,0)
}
SubShader {
 LOD 200
...
void main()
{
    u_xlat0.xy = (-_UVRescale.xy) + _UVRescale.zw;
    u_xlat0.xy = vs_TEXCOORD0.xy * u_xlat0.xy + _UVRescale.xy;
...
; Schema: 0
                                             ...
                                             %1 = OpExtInstImport "GLSL.std.450" 
                                                    OpMemoryModel Logical GLSL450 
                                                    OpEntryPoint Fragment %4 "main" %26 %48 %53 
...
UniformConstant read_only Texture2DSampled* %40 = OpVariable UniformConstant 
                             Private f32_3* %45 = OpVariable Private 
                                            %47 = OpTypePointer Input %10 
                               Input f32_4* %48 = OpVariable Input 
                                            %52 = OpTypePointer Output %10 
                             ...
                             Uniform f32_4* %21 = OpAccessChain %13 %15 
                                      ...
                                      f32_2 %27 = OpLoad %26 
                                      f32_2 %28 = OpLoad %9 
                                      f32_2 %29 = OpFMul %27 %28 
                             Uniform f32_4* %30 = OpAccessChain %13 %15 
                                      f32_4 %31 = OpLoad %30 
                                      f32_2 %32 = OpVectorShuffle %31 %31 0 1 
                                      f32_2 %33 = OpFAdd %29 %32 
                                                    OpStore %9 %33 
                 read_only Texture2DSampled %41 = OpLoad %40 
                                      f32_2 %42 = OpLoad %9 
                                      ...
                                      f32_4 %56 = OpVectorShuffle %55 %54 4 5 6 3 
                                                    OpStore %53 %56 
                                Output f32* %61 = OpAccessChain %53 %59 
                                                    OpStore %61 %57 
                                                    OpReturn
                                                    OpFunctionEnd
"
