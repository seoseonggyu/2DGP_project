...
//
///////////////////////////////////////////
Shader "Daikon Forge/Default UI Shader MaskReveal" {
Properties {
_MainTex ("Base (RGB), Alpha (A)", 2D) = "white" { }
_MaskTex ("Mask", 2D) = "white" { }
_RevealPercent ("Reveal", Range(0, 1)) = 0
}
SubShader {
 LOD 200
 Tags { "IGNOREPROJECTOR" = "true" "PreviewType" = "Plane" "QUEUE" = "Overlay-10" "RenderType" = "Transparent" }
 Pass {
  LOD 200
  Tags { "IGNOREPROJECTOR" = "true" "PreviewType" = "Plane" "QUEUE" = "Overlay-10" "RenderType" = "Transparent" }
...
; Schema: 0
                                             ...
                                             %1 = OpExtInstImport "GLSL.std.450" 
                                                    OpMemoryModel Logical GLSL450 
                                                    OpEntryPoint Fragment %4 "main" %11 %40 %52 %112 
...
UniformConstant read_only Texture2DSampled* %78 = OpVariable UniformConstant 
                     ...
                     Uniform struct {f32;}* %92 = OpVariable Uniform 
                                            %93 = OpTypePointer Uniform %6 
                                           %111 = OpTypePointer Output %29 
                 ...
                 read_only Texture2DSampled %79 = OpLoad %78 
                               ...
                               Private f32* %83 = OpAccessChain %46 %18 
                                                    OpStore %83 %82 
                               Private f32* %85 = OpAccessChain %46 %18 
                                        f32 %86 = OpLoad %85 
                                        f32 %87 = OpFNegate %86 
                                        f32 %88 = OpFAdd %87 %26 
                                                    OpStore %84 %88 
                               Uniform f32* %94 = OpAccessChain %92 %69 
                                        f32 %95 = OpLoad %94 
                                        f32 %96 = OpFNegate %95 
                                        f32 %97 = OpFAdd %96 %26 
                                                    OpStore %89 %97 
                                       ...
                                       f32 %101 = OpFAdd %99 %100 
                                                    OpStore %89 %101 
                                       f32 %102 = OpLoad %89 
                                      bool %103 = OpFOrdLessThan %102 %37 
                                                    OpStore %63 %103 
                                      bool %104 = OpLoad %63 
                                       i32 %105 = OpSelect %104 %70 %69 
                                       i32 %106 = OpIMul %105 %72 
                                      bool %107 = OpINotEqual %106 %69 
