...
//
///////////////////////////////////////////
Shader "Daikon Forge/Default UI Shader Highest Queue" {
Properties {
_MainTex ("Base (RGB), Alpha (A)", 2D) = "white" { }
}
SubShader {
 LOD 200
 Tags { "HighQueue" = "HighQueue" "IGNOREPROJECTOR" = "true" "PreviewType" = "Plane" "QUEUE" = "Overlay+8500" "RenderType" = "Transparent" }
 Pass {
  LOD 200
  Tags { "HighQueue" = "HighQueue" "IGNOREPROJECTOR" = "true" "PreviewType" = "Plane" "QUEUE" = "Overlay+8500" "RenderType" = "Transparent" }
