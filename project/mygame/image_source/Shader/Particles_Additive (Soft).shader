...
; Schema: 0
                                             ...
                                             %1 = OpExtInstImport "GLSL.std.450" 
                                                    OpMemoryModel Logical GLSL450 
                                                    OpEntryPoint Fragment %4 "main" %12 %74 %84 %102 
                                                    OpExecutionMode %4 OriginUpperLeft 
...
UniformConstant read_only Texture2DSampled* %81 = OpVariable UniformConstant 
                 ...
                 read_only Texture2DSampled %82 = OpLoad %81 
                               ...
                               Private f32* %87 = OpAccessChain %9 %26 
                                        f32 %88 = OpLoad %87 
                               Private f32* %89 = OpAccessChain %80 %42 
                                        f32 %90 = OpLoad %89 
                                        f32 %91 = OpFMul %88 %90 
                               Private f32* %92 = OpAccessChain %9 %26 
                                                    OpStore %92 %91 
                                      f32_4 %96 = OpLoad %80 
                              ...
                              Private f32* %109 = OpAccessChain %9 %26 
                                       f32 %110 = OpLoad %109 
                               Output f32* %112 = OpAccessChain %102 %42 
                                                    OpStore %112 %110 
                                                    OpReturn
                                                    OpFunctionEnd
"
