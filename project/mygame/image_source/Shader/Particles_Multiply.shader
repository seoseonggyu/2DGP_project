...
void main()
{
    ...
    u_xlat0 = vs_COLOR0 * u_xlat10_0 + vec4(-1.0, -1.0, -1.0, -1.0);
...
; Schema: 0
                                             ...
                                             %1 = OpExtInstImport "GLSL.std.450" 
                                                    OpMemoryModel Logical GLSL450 
                                                    OpEntryPoint Fragment %4 "main" %17 %27 %40 
...
UniformConstant read_only Texture2DSampled* %13 = OpVariable UniformConstant 
                             ...
                             Private f32_4* %32 = OpVariable Private 
                                      ...
                                      f32_4 %37 = OpConstantComposite %36 %36 %36 %36 
...
void main()
{
    ...
    u_xlat2 = u_xlat0 * u_xlat10_1 + vec4(-1.0, -1.0, -1.0, -1.0);
...
; Schema: 0
                                             ...
                                             %1 = OpExtInstImport "GLSL.std.450" 
                                                    OpMemoryModel Logical GLSL450 
                                                    OpEntryPoint Fragment %4 "main" %11 %77 %86 %109 
                                                    OpExecutionMode %4 OriginUpperLeft 
                                                    OpDecorate %11 Location 11 
...
UniformConstant read_only Texture2DSampled* %83 = OpVariable UniformConstant 
                            ...
                            Private f32_4* %103 = OpVariable Private 
                             ...
                             Output f32_4* %109 = OpVariable Output 
                                     f32_4 %114 = OpConstantComposite %50 %50 %50 %50 
                                        void %4 = OpFunction None %3 
                                             %5 = OpLabel 
                                      f32_4 %13 = OpLoad %11 
                 ...
                 read_only Texture2DSampled %84 = OpLoad %83 
                                      ...
                                      f32_4 %88 = OpImageSampleImplicitLod %84 %87 
                                                    OpStore %82 %88 
                               Private f32* %89 = OpAccessChain %9 %29 
                                        f32 %90 = OpLoad %89 
                               Private f32* %91 = OpAccessChain %82 %45 
                                        f32 %92 = OpLoad %91 
                                        f32 %93 = OpFMul %90 %92 
                               Private f32* %94 = OpAccessChain %9 %45 
                                                    OpStore %94 %93 
                                      f32_4 %96 = OpLoad %82 
