...
//
///////////////////////////////////////////
Shader "Hidden/Kvant/Tunnel/Debug Blit" {
Properties {
_MainTex ("-", 2D) = "" { }
}
SubShader {
...
void main()
{
    ...
    SV_Target0.xyz = u_xlat10_0.xyz * vec3(0.5, 0.5, 0.5) + vec3(0.5, 0.5, 0.5);
    SV_Target0.w = 1.0;
    return;
}
...
UniformConstant read_only Texture2DSampled* %13 = OpVariable UniformConstant 
                 ...
                 read_only Texture2DSampled %14 = OpLoad %13 
                                      ...
                                      f32_3 %28 = OpFAdd %27 %26 
                                      f32_4 %29 = OpLoad %23 
                                      f32_4 %30 = OpVectorShuffle %29 %28 4 5 6 3 
                                                    OpStore %23 %30 
                                Output f32* %35 = OpAccessChain %23 %33 
                                                    OpStore %35 %31 
                                                    OpReturn
                                                    OpFunctionEnd
"
