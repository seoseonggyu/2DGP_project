...
void main()
{
    ...
    SV_Target0.xyz = vec3(u_xlat6) * u_xlat10_1.xyz + u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
; Schema: 0
                                             ...
                                             %1 = OpExtInstImport "GLSL.std.450" 
                                                    OpMemoryModel Logical GLSL450 
                                                    OpEntryPoint Fragment %4 "main" %17 %62 
...
UniformConstant read_only Texture2DSampled* %13 = OpVariable UniformConstant 
                ...
                Uniform struct {f32; f32;}* %28 = OpVariable Uniform 
                                            %29 = OpTypeInt 32 1 
                                        i32 %30 = OpConstant 1 
...
UniformConstant read_only Texture2DSampled* %44 = OpVariable UniformConstant 
                 ...
                 read_only Texture2DSampled %14 = OpLoad %13 
                               ...
                               Uniform f32* %32 = OpAccessChain %28 %30 
                                      ...
                                      f32_3 %39 = OpVectorShuffle %38 %38 0 1 2 
                                        f32 %40 = OpLoad %21 
                                      f32_3 %41 = OpCompositeConstruct %40 %40 %40 
                 ...
                 read_only Texture2DSampled %45 = OpLoad %44 
                                      ...
                                      f32_4 %47 = OpImageSampleImplicitLod %45 %46 
                                                    OpStore %43 %47 
                               Private f32* %48 = OpAccessChain %43 %23 
                                        f32 %49 = OpLoad %48 
                               Uniform f32* %51 = OpAccessChain %28 %50 
                                        f32 %52 = OpLoad %51 
                                        f32 %53 = OpFMul %49 %52 
                                                    OpStore %21 %53 
                                        f32 %54 = OpLoad %21 
                                      ...
                                      f32_4 %65 = OpVectorShuffle %64 %63 4 5 6 3 
                                                    OpStore %62 %65 
                                Output f32* %68 = OpAccessChain %62 %23 
                                                    OpStore %68 %66 
                                                    OpReturn
                                                    OpFunctionEnd
"
