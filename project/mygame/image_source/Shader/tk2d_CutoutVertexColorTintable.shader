...
//
///////////////////////////////////////////
Shader "tk2d/CutoutVertexColorTintable" {
Properties {
...
; Schema: 0
                                             ...
                                             %1 = OpExtInstImport "GLSL.std.450" 
                                                    OpMemoryModel Logical GLSL450 
                                                    OpEntryPoint Fragment %4 "main" %17 %27 %46 
...
UniformConstant read_only Texture2DSampled* %13 = OpVariable UniformConstant 
                 ...
                 read_only Texture2DSampled %14 = OpLoad %13 
                             ...
                             Uniform f32_4* %37 = OpAccessChain %33 %35 
                                      ...
                                      f32_3 %40 = OpFAdd %30 %39 
                                                    OpStore %22 %40 
                                      f32_4 %42 = OpLoad %9 
                                      f32_4 %43 = OpLoad %27 
                                      f32_4 %44 = OpFMul %42 %43 
                                                    OpStore %41 %44 
                             Uniform f32_4* %47 = OpAccessChain %33 %35 
                                      f32_4 %48 = OpLoad %47 
                               ...
                               Private f32* %60 = OpAccessChain %41 %58 
                                        f32 %61 = OpLoad %60 
                                Output f32* %63 = OpAccessChain %46 %58 
                                                    OpStore %63 %61 
                                                    OpReturn
                                                    OpFunctionEnd
"
...
; Schema: 0
                                             ...
                                             %1 = OpExtInstImport "GLSL.std.450" 
                                                    OpMemoryModel Logical GLSL450 
                                                    OpEntryPoint Fragment %4 "main" %17 %23 %37 
                                                    OpExecutionMode %4 OriginUpperLeft 
                                                    OpDecorate %9 RelaxedPrecision 
                                                    OpDecorate %13 RelaxedPrecision 
                                                    OpDecorate %13 DescriptorSet 13 
...
UniformConstant read_only Texture2DSampled* %13 = OpVariable UniformConstant 
                 ...
                 read_only Texture2DSampled %14 = OpLoad %13 
                                      ...
                                      f32_4 %25 = OpFMul %21 %24 
                                                    OpStore %20 %25 
                               Private f32* %33 = OpAccessChain %20 %31 
                                        f32 %34 = OpLoad %33 
                                       bool %35 = OpFOrdGreaterThanEqual %29 %34 
                                                    OpStore %28 %35 
                                      f32_4 %38 = OpLoad %20 
                                                    OpStore %37 %38 
                                       bool %39 = OpLoad %28 
