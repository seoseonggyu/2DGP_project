...
//
///////////////////////////////////////////
Shader "Brave/Internal/GammaGamma" {
Properties {
...
; Schema: 0
                                             ...
                                             %1 = OpExtInstImport "GLSL.std.450" 
                                                    OpMemoryModel Logical GLSL450 
                                                    OpEntryPoint Fragment %4 "main" %17 %66 
                ...
                Uniform struct {f32; f32;}* %29 = OpVariable Uniform 
                 ...
                 read_only Texture2DSampled %14 = OpLoad %13 
                               ...
                               Uniform f32* %33 = OpAccessChain %29 %31 
                                      ...
                                      f32_3 %36 = OpFMul %26 %35 
                                                    OpStore %22 %36 
                                      f32_3 %37 = OpLoad %22 
                                      f32_3 %38 = OpExtInst %1 29 %37 
                                      f32_4 %39 = OpLoad %9 
                                      ...
                                      f32_3 %44 = OpVectorShuffle %43 %43 0 1 2 
                                        f32 %49 = OpDot %44 %48 
                                                    OpStore %42 %49 
                                        f32 %50 = OpLoad %42 
                                        f32 %52 = OpExtInst %1 37 %50 %51 
                                                    OpStore %42 %52 
                                        f32 %53 = OpLoad %42 
                               Uniform f32* %55 = OpAccessChain %29 %54 
                                        f32 %56 = OpLoad %55 
                                        f32 %57 = OpFNegate %56 
                                        f32 %58 = OpFMul %53 %57 
                               Uniform f32* %59 = OpAccessChain %29 %54 
                                        f32 %60 = OpLoad %59 
                                        f32 %61 = OpFAdd %58 %60 
                               Private f32* %64 = OpAccessChain %22 %63 
                                                    OpStore %64 %61 
                                      f32_4 %67 = OpLoad %9 
                                      f32_3 %68 = OpLoad %22 
