...
void main()
{
    ...
    SV_Target0 = u_xlat10_0.wwww * vec4(-1.0, -1.0, -1.0, 1.0) + vec4(1.0, 1.0, 1.0, 0.0);
    return;
}
...
UniformConstant read_only Texture2DSampled* %12 = OpVariable UniformConstant 
                              ...
                              Output f32_4* %24 = OpVariable Output 
                                      ...
                                      f32_4 %29 = OpConstantComposite %27 %27 %27 %28 
                                        f32 %31 = OpConstant 3.674022E-40 
                                      f32_4 %32 = OpConstantComposite %28 %28 %28 %31 
                                        void %4 = OpFunction None %3 
                                             %5 = OpLabel 
