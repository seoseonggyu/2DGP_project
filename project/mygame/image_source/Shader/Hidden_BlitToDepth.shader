...
; Schema: 0
                                             ...
                                             %1 = OpExtInstImport "GLSL.std.450" 
                                                    OpMemoryModel Logical GLSL450 
                                                    OpEntryPoint Fragment %4 "main" %9 %25 %34 
                                                    ...
                                                    OpDecorate %34 BuiltIn GlobalLinearId 
...
UniformConstant read_only Texture2DSampled* %21 = OpVariable UniformConstant 
                               ...
                               Input f32_2* %25 = OpVariable Input 
                                ...
                                Output f32* %34 = OpVariable Output 
                                        void %4 = OpFunction None %3 
                                             %5 = OpLabel 
                                      f32_4 %14 = OpLoad %9 
                 ...
                 read_only Texture2DSampled %22 = OpLoad %21 
                                      f32_2 %26 = OpLoad %25 
                                      f32_4 %27 = OpImageSampleImplicitLod %22 %26 
                                        f32 %30 = OpCompositeExtract %27 0 
                                                    OpStore %17 %30 
                                        f32 %31 = OpLoad %17 
                                Output f32* %33 = OpAccessChain %9 %29 
                                                    OpStore %33 %31 
                                        f32 %35 = OpLoad %17 
                                                    OpStore %34 %35 
                                                    OpReturn
