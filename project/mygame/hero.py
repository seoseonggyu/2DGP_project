...
from function import MOUSE_ANGLE
...
class WEAPON_IDLE:
    ...
    def do(self):  # 상태에 있을 때 지속적으로 행하는 행위, 숨쉬기
        ...
        self.way = MOUSE_ANGLE(self.mouse_x, self.mouse_y)
